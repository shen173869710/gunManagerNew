	...
	public void onClick(View v) {
		...
		switch (id) {
			case R.id.add_user_choose_layout_1:
				item_1 = !item_1;
				if (item_1) {
					add_user_choose_layout_1_tv.setBackgroundResource(R.mipmap.img_selected);
				}else {
					add_user_choose_layout_1_tv.setBackgroundResource(R.mipmap.img_unselected);
				}
				break;
			case R.id.add_user_choose_layout_2:
				item_2 = !item_2;
				if (item_2) {
					add_user_choose_layout_2_tv.setBackgroundResource(R.mipmap.img_selected);
				}else {
					add_user_choose_layout_2_tv.setBackgroundResource(R.mipmap.img_unselected);
				}
				break;
			case R.id.add_user_choose_layout_3:
				item_3 = !item_3;
				if (item_3) {
					add_user_choose_layout_3_tv.setBackgroundResource(R.mipmap.img_selected);
				}else {
					add_user_choose_layout_3_tv.setBackgroundResource(R.mipmap.img_unselected);
				}
				break;
